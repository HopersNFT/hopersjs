...
import {
	...
	State,
	UnbondingInfo
} from "./HopersStaking.types"
export interface HopersStakingReadOnlyInterface {
	contractAddress: string
	config: () => Promise<ConfigResponse>
	state: ({ blockTime }: { blockTime?: number }) => Promise<StateResponse>
	stakerInfo: ({ staker }: { staker: string }) => Promise<StakerInfoResponse>
	allStakers: ({
		limit,
		startAfter
	}: {
...
export class HopersStakingQueryClient implements HopersStakingReadOnlyInterface {
	...
	state = async ({ blockTime }: { blockTime?: number }): Promise<StateResponse> => {
		return this.client.queryContractSmart(this.contractAddress, {
			state: {
	...
	stakerInfo = async ({ staker }: { staker: string }): Promise<StakerInfoResponse> => {
		return this.client.queryContractSmart(this.contractAddress, {
			staker_info: {
				staker
			}
...
export class HopersStakingClient
	extends HopersStakingQueryClient
	implements HopersStakingInterface
{
