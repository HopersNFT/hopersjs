...
import { Uint128, WalletInfo, Expiration, TokenSelect } from "./HopersSwapHopers.types";
...
export declare class HopersSwapHopersMessageComposer implements HopersSwapHopersMessage {
    sender: string;
    contractAddress: string;
